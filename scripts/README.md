...
alias, and the survival objectives with censored and tied times —
sample weights, ranking groups, gblinear, DART, intercept estimation,
per-round metric oracles; 45 cases in total), and writes each case to `../fixtures/<name>.json`: data,
