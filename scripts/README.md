...
`iteration_range` and slicing; 49 cases in total), and writes each case to `../fixtures/<name>.json`: data,
...
`quality` cases are RNG-driven (`subsample`, `colsample_*`, DART, random
forests); training
