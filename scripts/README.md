...
raw margin, SHAP contributions on the first 50 rows, and for the numeric,
missing-value, categorical, multiclass, and DART cases in `INTERACTION_CASES`
SHAP interaction values on the first 5 rows) and the saved model JSON.
